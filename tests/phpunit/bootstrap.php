...
define('NL_NARRATIVE_DIR', dirname(dirname(dirname(__FILE__))));
define('OMEKA_DIR', dirname(dirname(NL_NARRATIVE_DIR)));
define('NL_DIR', dirname((NL_NARRATIVE_DIR)) . '/Neatline');
...
require_once 'cases/NeatlineNarrative_Case_Default.php';
require_once 'cases/NeatlineNarrative_Case_Fixture.php';
